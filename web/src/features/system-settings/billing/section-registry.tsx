    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          WeChatPayDirectEnabled: settings.WeChatPayDirectEnabled,
          ...
          WeChatPayPlatformPublicKeyID: settings.WeChatPayPlatformPublicKeyID,
          ...
          AlipayDirectEnabled: settings.AlipayDirectEnabled,
